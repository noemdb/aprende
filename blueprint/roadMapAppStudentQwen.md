...
|------|------------|---------------|
| **Frontend** | Next.js 16 + Tailwind 4 (Mobile First) | Responsivo, PWA instalable, acceso universal desde cualquier dispositivo |
| **Backend** | Node.js + Express | Ecosistema robusto, escalable |
| **Base de datos** | MySQL MariaDB | Relacional para datos estructurados (integración con SAEFL s2526) |
| **Notificaciones** | Firebase Cloud Messaging | Push para navegador (PWA) |
| **Analytics** | Mixpanel/Amplitude | Tracking de engagement |
| **PWA** | next-pwa | Instalación en móvil, trabajo offline, app-like experience |
...
### 1.1 Inicialización del proyecto web Mobile First

**Resultado esperado**

- Aplicación Next.js configurada con módulo `src/estudiants`
- Diseño Mobile First completamente responsivo (320px - 1920px)
- Configuración PWA para instalación en dispositivos móviles
- Base preparada para futura versión móvil nativa (v2.0)

**Acciones**

- Configurar proyecto Next.js 16+ con TypeScript estricto
...
- Instalar y configurar `next-pwa` para Progressive Web App
- Implementar viewport meta tags y diseño adaptativo mobile-first

**Prompt LLM tipo**

> Inicializa módulo de estudiantes en Next.js con arquitectura limpia, diseño mobile-first y configuración PWA.

> [!NOTE]
> La infraestructura para aplicaciones móviles nativas (iOS/Android con React Native o Flutter) se desarrollará en una **versión futura (v2.0)**. La versión actual se enfoca en una aplicación web responsive con PWA que funciona perfectamente en dispositivos móviles a través del navegador.

### 1.1b Configuración Progressive Web App (PWA)

**Objetivo**  
Habilitar instalación de la aplicación web en dispositivos móviles para experiencia app-like sin necesidad de tiendas de aplicaciones.

**Funcionalidades PWA**

- ✅ Instalable desde navegador móvil (iOS Safari, Android Chrome)
- ✅ Ícono en pantalla de inicio del dispositivo
- ✅ Splash screen personalizado
- ✅ Trabajo offline básico (caché de recursos estáticos)
- ✅ Notificaciones push (Android, limitado en iOS)
- ⚠️ Sin acceso a funcionalidades nativas avanzadas (cámara, giroscopio, NFC)

**Acciones**

- Instalar `next-pwa` y configurar en `next.config.ts`
- Crear `manifest.json` con íconos (192x192, 512x512) y metadata institucional
- Implementar Service Worker con estrategia de caché (network-first para API, cache-first para assets)
- Configurar notificaciones push con Firebase Cloud Messaging
- Diseñar splash screen con branding institucional
- Probar instalación en iOS (Safari) y Android (Chrome)

**Checkpoint**  
✅ Aplicación instalable en móvil sin pasar por app stores  
✅ Funciona offline para contenido previamente cargado  
✅ Notificaciones push funcionales en Android
